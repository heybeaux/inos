export type NodeType = 'claim' | 'question' | 'decision' | 'evidence' | 'branch' | 'synthesis' | 'deliberation' | 'constraint' | 'assumption' | 'insight' | 'artifact' | 'fact';
...
export type NodeStatus = 'fresh' | 'mature' | 'dormant' | 'stale' | 'negated' | 'orphaned';
...
export type EdgeType = 'supports' | 'challenges' | 'refines' | 'diverges' | 'merges' | 'depends_on' | 'references' | 'temporal' | 'replaces' | 'inherits';
